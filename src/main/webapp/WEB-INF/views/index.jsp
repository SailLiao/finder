	...
	<nav role="navigation" class="navbar navbar-custom">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a href="javascript:void(0)" class="navbar-brand">HX</a>
			</div>
			...
			<div id="bs-content-row-navbar-collapse-5" class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="active">
						<a href="${root}/index/getStarted">Getting Started</a>
					</li>
					<li class="active">
						...
						<div class="content-row">
							<h2 class="content-row-title">
								...
								<span>
									...
									<b>More Colors See</b>
									:
									<a href="colors.html">Flat UI Color Picker</a>
									)
								</span>
							</h2>
							<div class="row">
										...
										<div class="col-md-6">
                                          ...
                                          ================================================== -->
											...
											<div class="row tooltip-demo">
												<div class="col-md-12">
													<button type="button" class="btn btn-info btn-block" data-toggle="tooltip" data-placement="left" title="Tooltip on left">Tooltip on left</button>
													<br>
												</div>
												<div class="col-md-12">
													<button type="button" class="btn btn-info btn-block" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Tooltip on top</button>
													<br>
												</div>
												<div class="col-md-12">
													<button type="button" class="btn btn-info btn-block" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">Tooltip on bottom</button>
													<br>
												</div>
												<div class="col-md-12">
													<button type="button" class="btn btn-info btn-block" data-toggle="tooltip" data-placement="right" title="Tooltip on right">Tooltip on right</button>
													<br>
												</div>
											</div>
										</div>
								...
								<div class="col-md-6">
									<div class="jumbotron">
										<div class="jumbotron-photo">
											<img src="${root }/resources/images/Jumbotron.jpg" />
										</div>
										...
										<div id="carousel-content-row-generic" class="carousel slide" data-ride="carousel">
											...
											<div class="carousel-inner">
												<div class="item active">
													<img src="${root }/resources/images/slider1.jpg">
												</div>
												<div class="item">
													<img src="${root }/resources/images/slider2.jpg">
												</div>
												<div class="item">
													<img src="${root }/resources/images/slider3.jpg">
												</div>
											</div>
						...
						<div class="content-row">
							...
							<div class="row">
								<div class="col-sm-6 col-md-3">
									<div class="thumbnail">
										<img class="img-rounded" src="${root }/resources/images/thumbnail-1.jpg">
								...
								<div class="col-sm-6 col-md-3">
									<div class="thumbnail">
										<img class="img-rounded" src="${root }/resources/images/thumbnail-2.jpg">
										<div class="caption text-center">
											<h3>Thumbnail label</h3>
											<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id ...</p>
											<p>
								...
								<div class="col-sm-6 col-md-3">
									<div class="thumbnail">
										<img class="img-rounded" src="${root }/resources/images/thumbnail-3.jpg">
										<div class="caption text-center">
											<h3>Thumbnail label</h3>
											<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id ...</p>
											<p>
								...
								<div class="col-sm-6 col-md-3">
									<div class="thumbnail">
										<img class="img-rounded" src="${root }/resources/images/thumbnail-4.jpg">
										<div class="caption text-center">
											<h3>Thumbnail label</h3>
											<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id ...</p>
											<p>
	...
	<div class="site-footer">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<h3>Contribute</h3>
					<p>You want to help us and participate in the development or the documentation? Just fork Bootflat on and send us a pull request.</p>
				</div>
				<div class="col-md-4">
					<h3>Found a bug?</h3>
					<p>Open a new issue on GitHub. Please search for existing issues first and make sure to include all relevant information.</p>
				</div>
			</div>
			<hr class="dashed" />
			<div class="row">
